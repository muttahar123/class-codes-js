  ...
  return (
    <div>
      ...
      <center><select name="" id="">
          <option value="men" onClick={(e) => setSearch(e.target.men)}>Mens</option>
          <option value="women" onClick={(e) => setSearch(e.target.value)}>Womens</option>
          <option value="ssd" onClick={(e) => setSearch(e.target.value)}>ssd</option>
          <option value="gold" onClick={(e) => setSearch(e.target.value)}>gold</option>
        </select></center>  
      </div>
